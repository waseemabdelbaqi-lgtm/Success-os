...
export default function EnterpriseAdminHomePage() {
  ...
  return (
    <div>
      ...
      >
        <div style={{ fontWeight: 700, marginBottom: 6 }}>AI Agents Operating System</div>
        <p style={{ margin: '0 0 10px', color: '#0f766e', fontSize: 13 }}>
          Master Orchestrator routes every specialized agent — student, teacher, finance, owner, and
          more — with shared memory, knowledge graph, multi-LLM providers, and governance.
        </p>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <a
            href="/dashboard/admin/ai-agents-os"
            style={{
              background: '#0f766e',
              color: '#fff',
              padding: '8px 12px',
          ...
          <a
            href="/dashboard/admin/ai-orchestrator"
            style={{
              background: '#fff',
              color: '#0f766e',
