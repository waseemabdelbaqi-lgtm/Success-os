      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link
            ...
            className="rounded-xl bg-[#9e1722] px-3 py-2 text-sm font-semibold text-white"
          >
            ...
            {data.modules.map((mod) => (
              ...
              >
                ...
                {mod.href ? (
                  <Link
                    href={mod.href}
                    className="mt-4 inline-flex rounded-xl bg-[#9e1722] px-3 py-2 text-sm font-semibold text-white"
                  >
                    {isAr ? "فتح" : "Open"}
                  </Link>
                ) : (
