...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  ...
  [USER_ROLES.SCHOOL_STUDENT]: {
    id: USER_ROLES.SCHOOL_STUDENT,
    slug: "school-student",
    label: "School Student",
    description: "School learner journey and materials.",
    dashboardPath: "/dashboard/school-student",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  [USER_ROLES.UNIVERSITY_STUDENT]: {
    id: USER_ROLES.UNIVERSITY_STUDENT,
    slug: "university-student",
    label: "University Student",
    description: "University learner journey and programs.",
    dashboardPath: "/dashboard/university-student",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  ...
  [USER_ROLES.SCHOOL]: {
    ...
    dashboardPath: "/partners/dashboard?type=school",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  [USER_ROLES.COLLEGE]: {
    id: USER_ROLES.COLLEGE,
    slug: "college",
    label: "College",
    description: "College administration and academic programs.",
    dashboardPath: "/partners/dashboard?type=college",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  [USER_ROLES.UNIVERSITY]: {
    ...
    dashboardPath: "/partners/dashboard?type=university",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  [USER_ROLES.EDUCATIONAL_CENTER]: {
    ...
    dashboardPath: "/partners/dashboard?type=center",
    tier: "education",
    selfRegisterable: true,
    category: "education",
  },
  ...
  [USER_ROLES.EMPLOYER]: {
    ...
    dashboardPath: "/partners/dashboard?type=employer",
    tier: "employment",
    selfRegisterable: true,
    category: "employment",
  },
  [USER_ROLES.RECRUITMENT_COMPANY]: {
    id: USER_ROLES.RECRUITMENT_COMPANY,
    slug: "recruitment-company",
    label: "Recruitment Company",
    description: "Recruitment pipelines and employer partnerships.",
    dashboardPath: "/dashboard/recruitment-company",
    tier: "employment",
    selfRegisterable: true,
    category: "employment",
  },
