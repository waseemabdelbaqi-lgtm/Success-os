export const lessonProductionPipeline=[
 ...
 {id:'curriculum',label:'Curriculum alignment',task:'reasoning',providers:['ollama-local','openai'],required:true},
 {id:'lesson',label:'Original lesson writing',task:'lesson-writing',providers:['ollama-local','openai'],required:true},
 {id:'questions',label:'Assessment generation',task:'question-generation',providers:['ollama-local','openai'],required:true},
 {id:'visuals',label:'Educational visuals',task:'image',providers:['openai','flux','ideogram'],required:false},
 {id:'motion',label:'Animation & simulation',task:'animation',providers:['runway','pika','luma'],required:false},
 {id:'teacher',label:'Human AI teacher',task:'avatar-video',providers:['heygen','synthesia','tavus','colossyan','elai'],required:true},
 {id:'voice',label:'Voice & dubbing',task:'voice',providers:['elevenlabs','cartesia'],required:false},
 {id:'translation',label:'Translation & subtitles',task:'translation',providers:['ollama-local','openai','deepl'],required:true},
 {id:'math',label:'Formula validation',task:'math',providers:['sympy','mathpix'],required:false},
 {id:'quality',label:'Scientific and academic QA',task:'quality',providers:['ollama-local','openai'],required:true},
