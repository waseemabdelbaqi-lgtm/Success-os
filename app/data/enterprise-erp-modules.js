...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'dynamic-platform', label: 'Dynamic Platform Engine', href: '/dashboard/admin/dynamic-platform', icon: 'sliders', group: 'ops', crud: true },
  { id: 'dpe-pages', label: 'Dynamic Pages', href: '/dashboard/admin/dpe-pages', icon: 'file', group: 'ops', crud: true },
  { id: 'dpe-labels', label: 'Titles & Labels', href: '/dashboard/admin/dpe-labels', icon: 'file', group: 'ops', crud: true },
  { id: 'dpe-navigation', label: 'Dynamic Navigation', href: '/dashboard/admin/dpe-navigation', icon: 'list', group: 'ops', crud: true },
  { id: 'dpe-buttons', label: 'Buttons & Actions', href: '/dashboard/admin/dpe-buttons', icon: 'gear', group: 'ops', crud: true },
  { id: 'dpe-forms', label: 'Form Builder', href: '/dashboard/admin/dpe-forms', icon: 'file', group: 'ops', crud: true },
  { id: 'dpe-filters', label: 'Filter Engine', href: '/dashboard/admin/dpe-filters', icon: 'list', group: 'ops', crud: true },
  { id: 'dpe-journeys', label: 'Journey Builder', href: '/dashboard/admin/dpe-journeys', icon: 'list', group: 'ops', crud: true },
  { id: 'dpe-dashboards', label: 'Dashboard Builder', href: '/dashboard/admin/dpe-dashboards', icon: 'chart', group: 'ops', crud: true },
  { id: 'dpe-tables', label: 'Table Engine', href: '/dashboard/admin/dpe-tables', icon: 'list', group: 'ops', crud: true },
  { id: 'dpe-settings', label: 'Settings Registry', href: '/dashboard/admin/dpe-settings', icon: 'gear', group: 'ops', crud: true },
  { id: 'dpe-flags', label: 'Feature Flags', href: '/dashboard/admin/dpe-flags', icon: 'flag', group: 'ops', crud: true },
  { id: 'dpe-notifications', label: 'Notification Templates', href: '/dashboard/admin/dpe-notifications', icon: 'bell', group: 'ops', crud: true },
  { id: 'dpe-workflows', label: 'Workflow Builder', href: '/dashboard/admin/dpe-workflows', icon: 'list', group: 'ops', crud: true },
  { id: 'dpe-branding', label: 'Dynamic Branding', href: '/dashboard/admin/dpe-branding', icon: 'spark', group: 'ops', crud: true },
  { id: 'dpe-quality', label: 'Quality Audit', href: '/dashboard/admin/dpe-quality', icon: 'award', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'dynamic-platform': crudSchema({
    id: 'dynamic-platform',
    label: 'Dynamic Platform Engine',
    collection: 'dpe-pages',
  ...
  'dpe-pages': crudSchema({ id: 'dpe-pages', label: 'Dynamic Pages', collection: 'dpe-pages', actions: ['export'] }),
  'dpe-labels': crudSchema({ id: 'dpe-labels', label: 'Titles & Labels', collection: 'dpe-labels', actions: ['export'] }),
  'dpe-navigation': crudSchema({ id: 'dpe-navigation', label: 'Dynamic Navigation', collection: 'dpe-nav', actions: ['export'] }),
  'dpe-buttons': crudSchema({ id: 'dpe-buttons', label: 'Buttons & Actions', collection: 'dpe-buttons', actions: ['export'] }),
  'dpe-forms': crudSchema({ id: 'dpe-forms', label: 'Form Builder', collection: 'dpe-forms', actions: ['export'] }),
  'dpe-filters': crudSchema({ id: 'dpe-filters', label: 'Filter Engine', collection: 'dpe-filters', actions: ['export'] }),
  'dpe-journeys': crudSchema({ id: 'dpe-journeys', label: 'Journey Builder', collection: 'dpe-journeys', actions: ['export'] }),
  'dpe-dashboards': crudSchema({ id: 'dpe-dashboards', label: 'Dashboard Builder', collection: 'dpe-dashboards', actions: ['export'] }),
  'dpe-tables': crudSchema({ id: 'dpe-tables', label: 'Table Engine', collection: 'dpe-tables', actions: ['export'] }),
  'dpe-settings': crudSchema({ id: 'dpe-settings', label: 'Settings Registry', collection: 'dpe-settings', actions: ['export'] }),
  'dpe-flags': crudSchema({ id: 'dpe-flags', label: 'Feature Flags', collection: 'dpe-feature-flags', actions: ['export'] }),
  'dpe-notifications': crudSchema({ id: 'dpe-notifications', label: 'Notification Templates', collection: 'dpe-notifications', actions: ['export'] }),
  'dpe-workflows': crudSchema({ id: 'dpe-workflows', label: 'Workflow Builder', collection: 'dpe-workflows', actions: ['export'] }),
  'dpe-branding': crudSchema({ id: 'dpe-branding', label: 'Dynamic Branding', collection: 'dpe-branding', actions: ['export'] }),
  'dpe-quality': crudSchema({ id: 'dpe-quality', label: 'Quality Audit', collection: 'dpe-quality-findings', actions: ['export'] }),
