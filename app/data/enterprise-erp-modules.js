...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'multi-tenant-platform', label: 'Multi-Tenant Platform', href: '/dashboard/admin/multi-tenant-platform', icon: 'building', group: 'ops', crud: true },
  { id: 'mt-tenants', label: 'Tenants', href: '/dashboard/admin/mt-tenants', icon: 'building', group: 'ops', crud: true },
  { id: 'mt-white-label', label: 'White Label', href: '/dashboard/admin/mt-white-label', icon: 'spark', group: 'ops', crud: true },
  { id: 'mt-modules', label: 'Tenant Modules', href: '/dashboard/admin/mt-modules', icon: 'sliders', group: 'ops', crud: true },
  { id: 'mt-subscriptions', label: 'Tenant Subscriptions', href: '/dashboard/admin/mt-subscriptions', icon: 'handshake', group: 'ops', crud: true },
  { id: 'mt-billing', label: 'Tenant Billing', href: '/dashboard/admin/mt-billing', icon: 'currency', group: 'ops', crud: true },
  { id: 'mt-limits', label: 'Tenant Limits', href: '/dashboard/admin/mt-limits', icon: 'gear', group: 'ops', crud: true },
  { id: 'mt-isolation', label: 'Data Isolation', href: '/dashboard/admin/mt-isolation', icon: 'lock', group: 'ops', crud: true },
  { id: 'mt-tenant-admin', label: 'Tenant Admin View', href: '/dashboard/admin/mt-tenant-admin', icon: 'users', group: 'ops', crud: true },
  { id: 'mt-analytics', label: 'Tenant Analytics', href: '/dashboard/admin/mt-analytics', icon: 'chart', group: 'ops', crud: true },
  { id: 'mt-security', label: 'Tenant Security', href: '/dashboard/admin/mt-security', icon: 'lock', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'multi-tenant-platform': crudSchema({
    id: 'multi-tenant-platform',
    label: 'Multi-Tenant Platform',
    collection: 'mt-tenants',
    searchable: ['name', 'subdomain', 'orgType', 'status', 'planKey'],
    columns: [
  ...
  'mt-tenants': crudSchema({ id: 'mt-tenants', label: 'Tenants', collection: 'mt-tenants', actions: ['export'] }),
  'mt-white-label': crudSchema({ id: 'mt-white-label', label: 'White Label', collection: 'mt-branding', actions: ['export'] }),
  'mt-modules': crudSchema({ id: 'mt-modules', label: 'Tenant Modules', collection: 'mt-module-overrides', actions: ['export'] }),
  'mt-subscriptions': crudSchema({ id: 'mt-subscriptions', label: 'Tenant Subscriptions', collection: 'mt-subscriptions', actions: ['export'] }),
  'mt-billing': crudSchema({ id: 'mt-billing', label: 'Tenant Billing', collection: 'mt-invoices', actions: ['export'] }),
  'mt-limits': crudSchema({ id: 'mt-limits', label: 'Tenant Limits', collection: 'mt-usage', actions: ['export'] }),
  'mt-isolation': crudSchema({ id: 'mt-isolation', label: 'Data Isolation', collection: 'mt-tenant-data', actions: ['export'] }),
  'mt-tenant-admin': crudSchema({ id: 'mt-tenant-admin', label: 'Tenant Admin View', collection: 'mt-tenants', actions: ['export'] }),
  'mt-analytics': crudSchema({ id: 'mt-analytics', label: 'Tenant Analytics', collection: 'mt-tenants', actions: ['export'] }),
  'mt-security': crudSchema({ id: 'mt-security', label: 'Tenant Security', collection: 'mt-impersonations', actions: ['export'] }),
