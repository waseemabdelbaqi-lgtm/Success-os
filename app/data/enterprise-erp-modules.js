...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'data-platform', label: 'Data Platform & Twins', href: '/dashboard/admin/data-platform', icon: 'chart', group: 'data', crud: true },
  { id: 'edp-graph', label: 'Knowledge Graph', href: '/dashboard/admin/edp-graph', icon: 'list', group: 'data', crud: true },
  { id: 'edp-learning', label: 'Learning Graph', href: '/dashboard/admin/edp-learning', icon: 'book', group: 'data', crud: true },
  { id: 'edp-skills', label: 'Skills Graph', href: '/dashboard/admin/edp-skills', icon: 'award', group: 'data', crud: true },
  { id: 'edp-twins', label: 'Digital Twins', href: '/dashboard/admin/edp-twins', icon: 'users', group: 'data', crud: true },
  { id: 'edp-personalization', label: 'Personalization', href: '/dashboard/admin/edp-personalization', icon: 'spark', group: 'data', crud: true },
  { id: 'edp-recommendations', label: 'Recommendations', href: '/dashboard/admin/edp-recommendations', icon: 'spark', group: 'data', crud: true },
  { id: 'edp-predictions', label: 'Predictive Analytics', href: '/dashboard/admin/edp-predictions', icon: 'chart', group: 'data', crud: true },
  { id: 'edp-decisions', label: 'Decision Support', href: '/dashboard/admin/edp-decisions', icon: 'chart', group: 'data', crud: true },
  { id: 'edp-governance', label: 'Data Governance', href: '/dashboard/admin/edp-governance', icon: 'lock', group: 'data', crud: true },
  { id: 'edp-events', label: 'Event Stream', href: '/dashboard/admin/edp-events', icon: 'bell', group: 'data', crud: true },
  { id: 'edp-features', label: 'Feature Store', href: '/dashboard/admin/edp-features', icon: 'list', group: 'data', crud: true },
  { id: 'edp-quality', label: 'Data Quality', href: '/dashboard/admin/edp-quality', icon: 'award', group: 'data', crud: true },
  { id: 'edp-search', label: 'Search Index', href: '/dashboard/admin/edp-search', icon: 'list', group: 'data', crud: true },
  { id: 'edp-semantic', label: 'Semantic Layer', href: '/dashboard/admin/edp-semantic', icon: 'file', group: 'data', crud: true },
  { id: 'edp-ai-pipeline', label: 'AI Training Pipeline', href: '/dashboard/admin/edp-ai-pipeline', icon: 'spark', group: 'data', crud: true },
  { id: 'edp-simulation', label: 'Simulation Engine', href: '/dashboard/admin/edp-simulation', icon: 'sliders', group: 'data', crud: true },
  { id: 'edp-intelligence', label: 'Owner Intelligence', href: '/dashboard/admin/edp-intelligence', icon: 'chart', group: 'data', crud: true },
]);
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'data-platform': crudSchema({
    id: 'data-platform',
    label: 'Data Platform & Twins',
    collection: 'edp-entities',
    searchable: ['name', 'kind', 'key'],
    columns: [
      { key: 'kind', label: 'Kind' },
      { key: 'name', label: 'Name' },
      { key: 'country', label: 'Country' },
  ...
  'edp-graph': crudSchema({ id: 'edp-graph', label: 'Knowledge Graph', collection: 'edp-edges', actions: ['export'] }),
  'edp-learning': crudSchema({ id: 'edp-learning', label: 'Learning Graph', collection: 'edp-learning-progress', actions: ['export'] }),
  'edp-skills': crudSchema({ id: 'edp-skills', label: 'Skills Graph', collection: 'edp-entities', actions: ['export'] }),
  'edp-twins': crudSchema({ id: 'edp-twins', label: 'Digital Twins', collection: 'edp-twins', actions: ['export'] }),
  'edp-personalization': crudSchema({ id: 'edp-personalization', label: 'Personalization', collection: 'edp-personalization', actions: ['export'] }),
  'edp-recommendations': crudSchema({ id: 'edp-recommendations', label: 'Recommendations', collection: 'edp-recommendations', actions: ['export'] }),
  'edp-predictions': crudSchema({ id: 'edp-predictions', label: 'Predictive Analytics', collection: 'edp-predictions', actions: ['export'] }),
  'edp-decisions': crudSchema({ id: 'edp-decisions', label: 'Decision Support', collection: 'edp-decisions', actions: ['export'] }),
  'edp-governance': crudSchema({ id: 'edp-governance', label: 'Data Governance', collection: 'edp-schemas', actions: ['export'] }),
  'edp-events': crudSchema({ id: 'edp-events', label: 'Event Stream', collection: 'edp-events', actions: ['export'] }),
  'edp-features': crudSchema({ id: 'edp-features', label: 'Feature Store', collection: 'edp-features', actions: ['export'] }),
  'edp-quality': crudSchema({ id: 'edp-quality', label: 'Data Quality', collection: 'edp-quality-findings', actions: ['export'] }),
  'edp-search': crudSchema({ id: 'edp-search', label: 'Search Index', collection: 'edp-search-index', actions: ['export'] }),
  'edp-semantic': crudSchema({ id: 'edp-semantic', label: 'Semantic Layer', collection: 'edp-masters', actions: ['export'] }),
  'edp-ai-pipeline': crudSchema({ id: 'edp-ai-pipeline', label: 'AI Training Pipeline', collection: 'edp-training-jobs', actions: ['export'] }),
  'edp-simulation': crudSchema({ id: 'edp-simulation', label: 'Simulation Engine', collection: 'edp-simulations', actions: ['export'] }),
  'edp-intelligence': crudSchema({ id: 'edp-intelligence', label: 'Owner Intelligence', collection: 'edp-decisions', actions: ['export'] }),
});
