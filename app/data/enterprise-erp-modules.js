...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  // Global Marketplace
  { id: 'global-marketplace', label: 'Global Marketplace', href: '/dashboard/admin/global-marketplace', icon: 'currency', group: 'ops', crud: true },
  { id: 'market-listings', label: 'Market Listings', href: '/dashboard/admin/market-listings', icon: 'list', group: 'ops', crud: true },
  { id: 'market-bookings', label: 'Bookings', href: '/dashboard/admin/market-bookings', icon: 'list', group: 'ops', crud: true },
  { id: 'market-availability', label: 'Availability Engine', href: '/dashboard/admin/market-availability', icon: 'gear', group: 'ops', crud: true },
  { id: 'market-search', label: 'Market Search', href: '/dashboard/admin/market-search', icon: 'list', group: 'ops', crud: true },
  { id: 'market-cart', label: 'Cart & Checkout', href: '/dashboard/admin/market-cart', icon: 'currency', group: 'ops', crud: true },
  { id: 'market-orders', label: 'Market Orders', href: '/dashboard/admin/market-orders', icon: 'file', group: 'ops', crud: true },
  { id: 'market-reviews', label: 'Reviews', href: '/dashboard/admin/market-reviews', icon: 'award', group: 'ops', crud: true },
  { id: 'market-subscriptions', label: 'Market Subscriptions', href: '/dashboard/admin/market-subscriptions', icon: 'handshake', group: 'ops', crud: true },
  { id: 'market-affiliates', label: 'Affiliates & Referrals', href: '/dashboard/admin/market-affiliates', icon: 'share', group: 'ops', crud: true },
  { id: 'market-disputes', label: 'Dispute Center', href: '/dashboard/admin/market-disputes', icon: 'life-ring', group: 'ops', crud: true },
  { id: 'market-analytics', label: 'Market Analytics', href: '/dashboard/admin/market-analytics', icon: 'chart', group: 'ops', crud: true },
  { id: 'market-security', label: 'Market Security', href: '/dashboard/admin/market-security', icon: 'lock', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'global-marketplace': crudSchema({
    id: 'global-marketplace',
    label: 'Global Marketplace',
    collection: 'market-listings',
    searchable: ['title', 'listingType', 'country'],
    columns: [
    ...
    fields: [
      { key: 'title', label: 'Title', type: 'text', required: true },
      { key: 'listingType', label: 'Type', type: 'text' },
      { key: 'price', label: 'Price', type: 'number' },
      { key: 'status', label: 'Status', type: 'select', options: ['active', 'inactive'] },
    ],
  }),
  'market-listings': crudSchema({ id: 'market-listings', label: 'Market Listings', collection: 'market-listings' }),
  'market-bookings': crudSchema({ id: 'market-bookings', label: 'Bookings', collection: 'market-bookings', actions: ['export'] }),
  'market-availability': crudSchema({ id: 'market-availability', label: 'Availability Engine', collection: 'market-availability' }),
  'market-search': crudSchema({ id: 'market-search', label: 'Market Search', collection: 'market-listings', actions: ['export'] }),
  'market-cart': crudSchema({ id: 'market-cart', label: 'Cart & Checkout', collection: 'market-carts', actions: ['export'] }),
  'market-orders': crudSchema({ id: 'market-orders', label: 'Market Orders', collection: 'market-orders', actions: ['export'] }),
  'market-reviews': crudSchema({ id: 'market-reviews', label: 'Reviews', collection: 'market-reviews' }),
  'market-subscriptions': crudSchema({ id: 'market-subscriptions', label: 'Market Subscriptions', collection: 'market-subscriptions' }),
  'market-affiliates': crudSchema({ id: 'market-affiliates', label: 'Affiliates & Referrals', collection: 'market-affiliates' }),
  'market-disputes': crudSchema({ id: 'market-disputes', label: 'Dispute Center', collection: 'market-disputes' }),
  'market-analytics': crudSchema({ id: 'market-analytics', label: 'Market Analytics', collection: 'market-orders', actions: ['export'] }),
  'market-security': crudSchema({ id: 'market-security', label: 'Market Security', collection: 'market-fraud-events', actions: ['export'] }),
});
