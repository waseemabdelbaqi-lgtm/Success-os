...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'business-intelligence', label: 'Business Intelligence', href: '/dashboard/admin/business-intelligence', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-executive', label: 'Executive Analytics', href: '/dashboard/admin/bi-executive', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-students', label: 'Student Analytics', href: '/dashboard/admin/bi-students', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-teachers', label: 'Teacher Analytics', href: '/dashboard/admin/bi-teachers', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-partners', label: 'Partner Analytics', href: '/dashboard/admin/bi-partners', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-finance', label: 'Financial Analytics', href: '/dashboard/admin/bi-finance', icon: 'currency', group: 'system', crud: true },
  { id: 'bi-hr', label: 'HR Analytics', href: '/dashboard/admin/bi-hr', icon: 'badge', group: 'system', crud: true },
  { id: 'bi-marketing', label: 'Marketing Analytics', href: '/dashboard/admin/bi-marketing', icon: 'megaphone', group: 'system', crud: true },
  { id: 'bi-ai', label: 'AI Analytics', href: '/dashboard/admin/bi-ai', icon: 'spark', group: 'system', crud: true },
  { id: 'bi-geo', label: 'Geographic Analytics', href: '/dashboard/admin/bi-geo', icon: 'globe', group: 'system', crud: true },
  { id: 'bi-reports', label: 'Report Builder', href: '/dashboard/admin/bi-reports', icon: 'file', group: 'system', crud: true },
  { id: 'bi-exports', label: 'Export Center', href: '/dashboard/admin/bi-exports', icon: 'file', group: 'system', crud: true },
  { id: 'bi-forecasts', label: 'Forecasting Engine', href: '/dashboard/admin/bi-forecasts', icon: 'chart', group: 'system', crud: true },
  { id: 'bi-kpis', label: 'KPI Center', href: '/dashboard/admin/bi-kpis', icon: 'sliders', group: 'system', crud: true },
  { id: 'bi-alerts', label: 'BI Alert Center', href: '/dashboard/admin/bi-alerts', icon: 'bell', group: 'system', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'business-intelligence': crudSchema({
    id: 'business-intelligence',
    label: 'Business Intelligence',
    collection: 'bi-snapshots',
    searchable: ['at', 'user'],
    actions: ['export'],
    columns: [
      { key: 'at', label: 'Snapshot' },
      { key: 'user', label: 'User' },
      { key: 'updatedAt', label: 'Updated' },
    ],
    fields: [
  ...
  'bi-reports': crudSchema({
    id: 'bi-reports',
    label: 'Report Builder',
    collection: 'bi-reports',
    searchable: ['name', 'groupBy', 'chartType'],
    columns: [
    ...
    fields: [
      ...
      { key: 'chartType', label: 'Chart', type: 'select', options: ['line', 'bar', 'area', 'pie', 'table', 'pivot', 'kpi'] },
      { key: 'schedule', label: 'Schedule', type: 'select', options: ['', 'daily', 'weekly', 'monthly'] },
      { key: 'status', label: 'Status', type: 'select', options: ['active', 'inactive'] },
    ],
  }),
  'bi-kpis': crudSchema({
    ...
    label: 'KPI Center',
    collection: 'bi-kpis',
    searchable: ['name', 'department', 'key'],
    columns: [
      { key: 'department', label: 'Department' },
      { key: 'name', label: 'KPI' },
    ...
    fields: [
      { key: 'department', label: 'Department', type: 'text', required: true },
      { key: 'key', label: 'Metric key', type: 'text', required: true },
      { key: 'name', label: 'Name', type: 'text', required: true },
  ...
  'bi-alerts': crudSchema({
    id: 'bi-alerts',
    label: 'BI Alert Center',
    collection: 'bi-alerts',
    searchable: ['name', 'metric', 'severity'],
    columns: [
    ...
    fields: [
      ...
      { key: 'op', label: 'Operator', type: 'select', options: ['gt', 'gte', 'lt', 'lte', 'eq'] },
  ...
  'bi-exports': crudSchema({
    id: 'bi-exports',
    label: 'Export Center',
    collection: 'bi-exports',
    searchable: ['filename', 'format', 'status'],
    actions: ['export'],
    columns: [
    ...
    fields: [
      ...
      { key: 'format', label: 'Format', type: 'select', options: ['pdf', 'excel', 'csv', 'print', 'email'] },
      { key: 'status', label: 'Status', type: 'select', options: ['ready', 'queued', 'sent'] },
    ],
  }),
  'bi-executive': crudSchema({ id: 'bi-executive', label: 'Executive Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-students': crudSchema({ id: 'bi-students', label: 'Student Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-teachers': crudSchema({ id: 'bi-teachers', label: 'Teacher Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-partners': crudSchema({ id: 'bi-partners', label: 'Partner Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-finance': crudSchema({ id: 'bi-finance', label: 'Financial Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-hr': crudSchema({ id: 'bi-hr', label: 'HR Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-marketing': crudSchema({ id: 'bi-marketing', label: 'Marketing Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-ai': crudSchema({ id: 'bi-ai', label: 'AI Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-geo': crudSchema({ id: 'bi-geo', label: 'Geographic Analytics', collection: 'bi-snapshots', actions: ['export'] }),
  'bi-forecasts': crudSchema({ id: 'bi-forecasts', label: 'Forecasting Engine', collection: 'bi-snapshots', actions: ['export'] }),
});
