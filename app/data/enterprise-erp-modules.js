...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'communication-platform', label: 'Communication Platform', href: '/dashboard/admin/communication-platform', icon: 'bell', group: 'ops', crud: true },
  { id: 'comm-messaging', label: 'Internal Messaging', href: '/dashboard/admin/comm-messaging', icon: 'users', group: 'ops', crud: true },
  { id: 'comm-meetings', label: 'Video Meetings', href: '/dashboard/admin/comm-meetings', icon: 'video', group: 'ops', crud: true },
  { id: 'comm-calls', label: 'Voice Calls', href: '/dashboard/admin/comm-calls', icon: 'bell', group: 'ops', crud: true },
  { id: 'comm-announcements', label: 'Announcements', href: '/dashboard/admin/comm-announcements', icon: 'megaphone', group: 'ops', crud: true },
  { id: 'comm-helpdesk', label: 'Help Desk', href: '/dashboard/admin/comm-helpdesk', icon: 'life-ring', group: 'ops', crud: true },
  { id: 'comm-notifications', label: 'Comm Notifications', href: '/dashboard/admin/comm-notifications', icon: 'bell', group: 'ops', crud: true },
  { id: 'comm-documents', label: 'Document Sharing', href: '/dashboard/admin/comm-documents', icon: 'file', group: 'ops', crud: true },
  { id: 'comm-calendar', label: 'Collaboration Calendar', href: '/dashboard/admin/comm-calendar', icon: 'list', group: 'ops', crud: true },
  { id: 'comm-collaboration', label: 'Collaboration Spaces', href: '/dashboard/admin/comm-collaboration', icon: 'users', group: 'ops', crud: true },
  { id: 'comm-parents', label: 'Parent Communication', href: '/dashboard/admin/comm-parents', icon: 'users', group: 'ops', crud: true },
  { id: 'comm-ai', label: 'Comm AI Assistant', href: '/dashboard/admin/comm-ai', icon: 'spark', group: 'ops', crud: true },
  { id: 'comm-search', label: 'Comm Global Search', href: '/dashboard/admin/comm-search', icon: 'list', group: 'ops', crud: true },
  { id: 'comm-security', label: 'Comm Security', href: '/dashboard/admin/comm-security', icon: 'lock', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'communication-platform': crudSchema({
    id: 'communication-platform',
    label: 'Communication Platform',
    collection: 'comm-channels',
  ...
  'comm-messaging': crudSchema({ id: 'comm-messaging', label: 'Internal Messaging', collection: 'comm-messages', actions: ['export'] }),
  'comm-meetings': crudSchema({ id: 'comm-meetings', label: 'Video Meetings', collection: 'comm-meetings', actions: ['add', 'edit'] }),
  'comm-calls': crudSchema({ id: 'comm-calls', label: 'Voice Calls', collection: 'comm-calls', actions: ['export'] }),
  'comm-announcements': crudSchema({ id: 'comm-announcements', label: 'Announcements', collection: 'comm-announcements', actions: ['add', 'edit', 'delete'] }),
  'comm-helpdesk': crudSchema({ id: 'comm-helpdesk', label: 'Help Desk', collection: 'comm-tickets', actions: ['add', 'edit'] }),
  'comm-notifications': crudSchema({ id: 'comm-notifications', label: 'Comm Notifications', collection: 'comm-notifications', actions: ['add'] }),
  'comm-documents': crudSchema({ id: 'comm-documents', label: 'Document Sharing', collection: 'comm-documents', actions: ['add', 'edit'] }),
  'comm-calendar': crudSchema({ id: 'comm-calendar', label: 'Collaboration Calendar', collection: 'comm-calendar', actions: ['add', 'edit'] }),
  'comm-collaboration': crudSchema({ id: 'comm-collaboration', label: 'Collaboration Spaces', collection: 'comm-workspaces', actions: ['add', 'edit'] }),
  'comm-parents': crudSchema({ id: 'comm-parents', label: 'Parent Communication', collection: 'comm-parent-messages', actions: ['add'] }),
  'comm-ai': crudSchema({ id: 'comm-ai', label: 'Comm AI Assistant', collection: 'comm-ai-sessions', actions: ['export'] }),
  'comm-search': crudSchema({ id: 'comm-search', label: 'Comm Global Search', collection: 'comm-messages', actions: ['export'] }),
  'comm-security': crudSchema({ id: 'comm-security', label: 'Comm Security', collection: 'comm-devices', actions: ['edit'] }),
});
