...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'ai-agents-os', label: 'AI Agents OS', href: '/dashboard/admin/ai-agents-os', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-orchestrator', label: 'AI Orchestrator', href: '/dashboard/admin/ai-orchestrator', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-student', label: 'Student AI', href: '/dashboard/admin/ai-student', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-parent', label: 'Parent AI', href: '/dashboard/admin/ai-parent', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-teacher', label: 'Teacher AI', href: '/dashboard/admin/ai-teacher', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-school', label: 'School AI', href: '/dashboard/admin/ai-school', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-university', label: 'University AI', href: '/dashboard/admin/ai-university', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-employer', label: 'Employer AI', href: '/dashboard/admin/ai-employer', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-hr', label: 'HR AI', href: '/dashboard/admin/ai-hr', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-finance', label: 'Finance AI', href: '/dashboard/admin/ai-finance', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-support', label: 'Support AI', href: '/dashboard/admin/ai-support', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-content-agents', label: 'Content AI Agents', href: '/dashboard/admin/ai-content-agents', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-marketing', label: 'Marketing AI', href: '/dashboard/admin/ai-marketing', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-sales', label: 'Sales AI', href: '/dashboard/admin/ai-sales', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-legal', label: 'Legal AI', href: '/dashboard/admin/ai-legal', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-owner', label: 'Owner AI', href: '/dashboard/admin/ai-owner', icon: 'spark', group: 'ops', crud: true },
  { id: 'ai-memory', label: 'AI Memory', href: '/dashboard/admin/ai-memory', icon: 'list', group: 'ops', crud: true },
  { id: 'ai-governance', label: 'AI Governance', href: '/dashboard/admin/ai-governance', icon: 'lock', group: 'ops', crud: true },
  { id: 'ai-providers', label: 'AI Providers', href: '/dashboard/admin/ai-providers', icon: 'sliders', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'ai-agents-os': crudSchema({
    id: 'ai-agents-os',
    label: 'AI Agents OS',
    collection: 'ai-agents',
    searchable: ['name', 'family', 'portal', 'status'],
    columns: [
  ...
  'ai-orchestrator': crudSchema({ id: 'ai-orchestrator', label: 'AI Orchestrator', collection: 'ai-agent-runs', actions: ['export'] }),
  'ai-student': crudSchema({ id: 'ai-student', label: 'Student AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-parent': crudSchema({ id: 'ai-parent', label: 'Parent AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-teacher': crudSchema({ id: 'ai-teacher', label: 'Teacher AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-school': crudSchema({ id: 'ai-school', label: 'School AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-university': crudSchema({ id: 'ai-university', label: 'University AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-employer': crudSchema({ id: 'ai-employer', label: 'Employer AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-hr': crudSchema({ id: 'ai-hr', label: 'HR AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-finance': crudSchema({ id: 'ai-finance', label: 'Finance AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-support': crudSchema({ id: 'ai-support', label: 'Support AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-content-agents': crudSchema({ id: 'ai-content-agents', label: 'Content AI Agents', collection: 'ai-agents', actions: ['export'] }),
  'ai-marketing': crudSchema({ id: 'ai-marketing', label: 'Marketing AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-sales': crudSchema({ id: 'ai-sales', label: 'Sales AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-legal': crudSchema({ id: 'ai-legal', label: 'Legal AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-owner': crudSchema({ id: 'ai-owner', label: 'Owner AI', collection: 'ai-agents', actions: ['export'] }),
  'ai-memory': crudSchema({ id: 'ai-memory', label: 'AI Memory', collection: 'ai-memories', actions: ['export'] }),
  'ai-governance': crudSchema({ id: 'ai-governance', label: 'AI Governance', collection: 'ai-usage', actions: ['export'] }),
  'ai-providers': crudSchema({ id: 'ai-providers', label: 'AI Providers', collection: 'ai-model-assignments', actions: ['export'] }),
