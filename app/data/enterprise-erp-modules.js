...
export const ENTERPRISE_ERP_NAV = Object.freeze([
  ...
  { id: 'global-integration-platform', label: 'Global Integration Platform', href: '/dashboard/admin/global-integration-platform', icon: 'globe', group: 'ops', crud: true },
  { id: 'gip-hub', label: 'Integration Hub', href: '/dashboard/admin/gip-hub', icon: 'gear', group: 'ops', crud: true },
  { id: 'gip-payments', label: 'Payment Gateways', href: '/dashboard/admin/gip-payments', icon: 'currency', group: 'ops', crud: true },
  { id: 'gip-communication', label: 'Comm Integrations', href: '/dashboard/admin/gip-communication', icon: 'bell', group: 'ops', crud: true },
  { id: 'gip-video', label: 'Video Integrations', href: '/dashboard/admin/gip-video', icon: 'video', group: 'ops', crud: true },
  { id: 'gip-ai', label: 'AI Integrations', href: '/dashboard/admin/gip-ai', icon: 'spark', group: 'ops', crud: true },
  { id: 'gip-storage', label: 'Storage Integrations', href: '/dashboard/admin/gip-storage', icon: 'file', group: 'ops', crud: true },
  { id: 'gip-auth', label: 'Auth Integrations', href: '/dashboard/admin/gip-auth', icon: 'lock', group: 'ops', crud: true },
  { id: 'gip-calendar', label: 'Calendar Integrations', href: '/dashboard/admin/gip-calendar', icon: 'list', group: 'ops', crud: true },
  { id: 'gip-maps', label: 'Maps Integrations', href: '/dashboard/admin/gip-maps', icon: 'globe', group: 'ops', crud: true },
  { id: 'gip-analytics', label: 'Analytics Integrations', href: '/dashboard/admin/gip-analytics', icon: 'chart', group: 'ops', crud: true },
  { id: 'gip-documents', label: 'Document Integrations', href: '/dashboard/admin/gip-documents', icon: 'file', group: 'ops', crud: true },
  { id: 'gip-marketplace', label: 'Integration Marketplace', href: '/dashboard/admin/gip-marketplace', icon: 'handshake', group: 'ops', crud: true },
  { id: 'gip-monitoring', label: 'Integration Monitoring', href: '/dashboard/admin/gip-monitoring', icon: 'chart', group: 'ops', crud: true },
  { id: 'gip-security', label: 'Integration Security', href: '/dashboard/admin/gip-security', icon: 'lock', group: 'ops', crud: true },
  // Money engines
...
export const ENTERPRISE_ERP_MODULES = Object.freeze({
  ...
  'global-integration-platform': crudSchema({
    id: 'global-integration-platform',
    label: 'Global Integration Platform',
    collection: 'gip-connectors',
    searchable: ['name', 'category', 'status', 'health'],
    columns: [
  ...
  'gip-hub': crudSchema({ id: 'gip-hub', label: 'Integration Hub', collection: 'gip-connectors', actions: ['export'] }),
  'gip-payments': crudSchema({ id: 'gip-payments', label: 'Payment Gateways', collection: 'gip-connectors', actions: ['export'] }),
  'gip-communication': crudSchema({ id: 'gip-communication', label: 'Comm Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-video': crudSchema({ id: 'gip-video', label: 'Video Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-ai': crudSchema({ id: 'gip-ai', label: 'AI Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-storage': crudSchema({ id: 'gip-storage', label: 'Storage Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-auth': crudSchema({ id: 'gip-auth', label: 'Auth Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-calendar': crudSchema({ id: 'gip-calendar', label: 'Calendar Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-maps': crudSchema({ id: 'gip-maps', label: 'Maps Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-analytics': crudSchema({ id: 'gip-analytics', label: 'Analytics Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-documents': crudSchema({ id: 'gip-documents', label: 'Document Integrations', collection: 'gip-connectors', actions: ['export'] }),
  'gip-marketplace': crudSchema({ id: 'gip-marketplace', label: 'Integration Marketplace', collection: 'gip-marketplace-installs', actions: ['export'] }),
  'gip-monitoring': crudSchema({ id: 'gip-monitoring', label: 'Integration Monitoring', collection: 'gip-calls', actions: ['export'] }),
  'gip-security': crudSchema({ id: 'gip-security', label: 'Integration Security', collection: 'gip-secrets', actions: ['export'] }),
