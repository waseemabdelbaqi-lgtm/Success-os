...
export default function StudentPortal(){
 ...
 return <div className="os-shell phase11-private-shell"><Sidebar active="student-portal"/><main className="os-main"><Topbar/><div className="os-content student-dashboard-simple">
