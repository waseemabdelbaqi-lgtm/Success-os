  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10" dir="rtl">
      ...
      <p className="mt-2 text-sm text-zinc-600">
        ...
        <a className="font-semibold text-[#9e1722] underline" href="/preview-dashboards.html">
        ...
        {PUBLIC_DASHBOARD_LINKS.map((item, index) => (
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-sm font-semibold text-[#9e1722]">
              ...
              <Link
                href={item.href}
                className="rounded-xl bg-[#9e1722] px-4 py-2 text-sm font-semibold text-white"
              >
                فتح اللوحة
              </Link>
            </div>
      ...
      <div className="mt-8 flex flex-wrap gap-4 text-sm">
        <Link className="font-semibold text-[#9e1722] underline" href="/dashboard/admin/permissions">
          توزيع الصلاحيات من الأدمن
        </Link>
        <Link className="font-semibold text-[#9e1722] underline" href="/dashboard/user-dashboards">
          دليل كل اللوحات
        </Link>
        <Link className="font-semibold text-[#9e1722] underline" href="/dashboard/admin">
          لوحة الأدمن
        </Link>
      </div>
    </main>
