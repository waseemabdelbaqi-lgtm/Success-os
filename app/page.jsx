...
const copy = {
  en: {
    ...
    footerText: 'The AI-powered lifelong Education Operating System.', footerCols: [['Platform', 'Learning', 'AI Tutor', 'Teachers', 'User dashboards', 'Super Admin', 'Education Passport'], ['Programs', 'EST & ACT', 'AP', 'IGCSE', 'A Level'], ['Company', 'About', 'Safety & Privacy', 'Contact', 'Success 4 Sure Academy']],
  ...
  ar: {
    ...
    footerText: 'نظام التعليم المدعوم بالذكاء الاصطناعي مدى الحياة.', footerCols: [['المنصة', 'التعلم', 'المعلم الذكي', 'المعلمون', 'لوحات المستخدمين', 'لوحة المشرف', 'الجواز التعليمي'], ['البرامج', 'EST وACT', 'AP', 'IGCSE', 'A Level'], ['الشركة', 'من نحن', 'الأمان والخصوصية', 'تواصل معنا', 'Success 4 Sure Academy']],
...
export default function HomePage() {
  ...
  const footerLinks = {
    Platform: { Learning: '/programs', 'AI Tutor': '/tutor', Teachers: '/teachers', 'User dashboards': '/dashboard/links', 'Super Admin': '/dashboard/super-admin', 'Education Passport': '/passport' },
    المنصة: { التعلم: '/programs', 'المعلم الذكي': '/tutor', المعلمون: '/teachers', 'لوحات المستخدمين': '/dashboard/links', 'لوحة المشرف': '/dashboard/super-admin', 'الجواز التعليمي': '/passport' },
